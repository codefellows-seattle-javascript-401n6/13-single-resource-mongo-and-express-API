...
Router.get('/api/coffee/:id', jsonParser, (req, res, next) => {
...
// POST
Router.post('/api/coffee', jsonParser, (req, res, next) => {
...
// PUT
Router.put('/api/coffee/:id', jsonParser, (req, res, next) => {
...
// DELETE
Router.delete('/api/coffee/:id', (req, res, next) => {
